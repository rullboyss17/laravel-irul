...
<head>
    ...
    <title>Edit Aktivitas | Portofolio</title>
...
<body>
    ...
    <main>
        ...
        <form action="{{ route('aktivitas.update', $aktivitas->id) }}" method="POST">
            ...
            <input type="text" name="nama_aktivitas" value="{{ $aktivitas->nama_aktivitas }}" required>

            <label for="deskripsi">Deskripsi</label>
            <textarea name="deskripsi" required>{{ $aktivitas->deskripsi }}</textarea>

            <label for="tanggal">Tanggal</label>
            <input type="date" name="tanggal" value="{{ $aktivitas->tanggal }}" required>
        ...
        <a href="{{ route('aktivitas') }}" class="btn-back">Batal</a>
    </main>
